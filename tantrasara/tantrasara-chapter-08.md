# Chapter Eight: The Nature of the Categories

We have walked the path of Time inside the breath and the path of Space inside the body. Now the book pauses the practices and turns to look closely at the building blocks themselves — the *tattva*-s, the categories or reality levels that make up the whole map of manifestation. We met them by name in the last chapter. Now we ask what they actually are. And the answer overturns the most basic assumption a person ever makes about the world: the assumption that things cause other things.
...
And yet, succession clearly appears. The seed does come before the sprout. The potter does work before the pot exists. So where does that orderly sequence come from, if the real act is all at once?
...
So when the tradition speaks of one *tattva* "generating" the next, of the universe being produced from the category of *māyā* downward in sequence, this is the painting's internal logic. It is a real and useful way to read the scene. But the actual support of every category, at every instant, is not the category above it. It is the Light underneath all of them — the screen that never appears in the painting yet makes every figure in it possible.

This is why Abhinavagupta says the Lord's doership never disappears. In ordinary thinking, once a cause has produced its effect, the cause is done; it steps back, and the effect stands on its own. But Consciousness is not like that. It does not produce the world and step back. It is the standing surface on which the world is, at every moment, being painted. Take away the screen and the whole scene vanishes — not into an earlier cause, but into nothing at all. The painting cannot outlast its canvas for even an instant.

## Why It Looks Like a Chain

You might ask: if the real act is timeless and all at once, why does it so persuasively look like a chain of causes unfolding in time?
